...
def calculate_stats(exp = Expediente):
    ...
    if exp.entrada_1 and exp.saida_1:
        ...
        res["remaining_minutes"] = max(0, 480 - res["worked_morning"])
    ...
    if res["is_complete_morning"] and exp.entrada_2:
        ...
        res["window_start"] = from_minutes(target - 10)
        res["window_end"] = from_minutes(target + 10)
